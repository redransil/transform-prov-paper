...
\hline
\makecell[l]{introduce} & \makecell[l]{CID of an asset} & \makecell[c]{$f(null) = x$ in order to introduce $x$ \\as a constant.}  & \makecell[c]{\includegraphics[width=.1\columnwidth]{builtInFns_introduce}}  \\
\hline
\makecell[l]{ignore} & \makecell[l]{null} & \makecell[c]{$f(x) = null$ drop $x$ \\from the computational graph.}  & \makecell[c]{\includegraphics[width=.1\columnwidth]{builtInFns_ignore}}  \\
\hline
\makecell[l]{down} & \makecell[l]{height ($int$)} & \makecell[c]{ $f(D\otimes null... \otimes null) = $ \\ $ null ... \otimes null \otimes D$ \\Shifts input down n+1 rows. \\ Height = n+2.}  & \makecell[c]{\includegraphics[width=.1\columnwidth]{builtInFns_down}}  \\
\hline
\makecell[l]{up} & \makecell[l]{height ($int$)} & \makecell[c]{ $f(null... \otimes null \otimes E) = $ \\ $ E\otimes null ... \otimes null $ \\Shifts input down n+1 rows. \\ Height = n+2.}  & \makecell[c]{\includegraphics[width=.1\columnwidth]{builtInFns_up}}  \\
\hline
...
\hline
\makecell[l]{braid} & \makecell[l]{null} & \makecell[c]{ $f(H \otimes I) = I\otimes H$ \\ Switches the order of two inputs.}  & \makecell[c]{\includegraphics[width=.1\columnwidth]{builtInFns_braid}}  \\
\hline
\makecell[l]{WASM} & \makecell[l]{CID of WASM \\ function} & \makecell[c]{ $f(J) = K$ \\ Runs function on input J to \\ produce output K.}  & \makecell[c]{\includegraphics[width=.1\columnwidth]{builtInFns_function}}  \\
\hline
\makecell[l]{IPDR} & \makecell[l]{CID of IPDR \\ docker image} & \makecell[c]{ $f(J) = K$ \\ Runs function on input J to \\ produce output K.}  & \makecell[c]{\includegraphics[width=.1\columnwidth]{builtInFns_function}}  \\
\hline
