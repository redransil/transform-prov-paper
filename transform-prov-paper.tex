...
\hline
\makecell[l]{\textbf{fn} \\ \textit{(See Table \ref{execTable})}} & \makecell[l]{Function definition chosen \\ from the Execution Table}\\
\hline
...
\hline
\makecell[l]{introduce} & \makecell[l]{CID of a type} & \makecell[c]{$f(null) = x$ in order to introduce $x$ \\as a constant.}  & \makecell[c]{\includegraphics[width=.1\columnwidth]{builtInFns_introduce}}  \\
\hline
...
\hline
\makecell[l]{down} & \makecell[l]{null} & \makecell[c]{ $f(D\otimes null... \otimes null) = $ \\ $ null ... \otimes null \otimes D$ \\Shifts input down n+1 rows. \\ Height = n+2.}  & \makecell[c]{\includegraphics[width=.1\columnwidth]{builtInFns_down}}  \\
\hline
